...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/api/event/index' => [[['_route' => 'api_event_index', '_controller' => 'App\\Controller\\EventController::index'], null, null, null, false, false, null]],
        '/api/event/create' => [[['_route' => 'api_event_create', '_controller' => 'App\\Controller\\EventController::create'], null, null, null, false, false, null]],
        '/api/room/index' => [[['_route' => 'app_room_index', '_controller' => 'App\\Controller\\RoomController::index'], null, null, null, false, false, null]],
        '/api/user/index' => [[['_route' => 'app_user_index', '_controller' => 'App\\Controller\\UserController::index'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/api(?'
    ...
    [ // $dynamicRoutes
        ...
        263 => [[['_route' => 'app_room_show', '_controller' => 'App\\Controller\\RoomController::show'], ['id'], null, null, false, true, null]],
        284 => [[['_route' => 'app_user_show', '_controller' => 'App\\Controller\\UserController::show'], ['id'], null, null, false, true, null]],
        322 => [
