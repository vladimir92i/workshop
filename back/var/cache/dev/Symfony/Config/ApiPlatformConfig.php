...
class ApiPlatformConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     * @param TValue $value
     * The list of enabled formats. The first one will be the default.
     * @default {"jsonopenapi":{"mime_types":["application\/vnd.openapi+json"]},"yamlopenapi":{"mime_types":["application\/vnd.openapi+yaml"]},"jsonld":{"mime_types":["application\/ld+json"]},"html":{"mime_types":["text\/html"]}}
